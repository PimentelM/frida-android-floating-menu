...
export default (activityName: string, config_: ConfigInterface, callback: (menu: MenuInterface) => void): void => {
  ...
  Java.perform(() => {
    ...
    class Menu implements MenuInterface {
      ...
      public readonly mCollapsed: any;
      public readonly mExpanded: any;
      public readonly featureView: any;
      public readonly launcherIcon: any;
      public readonly rootFrame: any;
      public curCollapse: any | null;
      public windowManager!: any;
      public readonly wmParams: any;
       ...
       * menu.attach()
       */
      constructor(public readonly context: any, config: ConfigInterface) {
        this.config = config;
      ...
      /** @internal */
      public killMenu(): void {
        this.windowManager.removeView(this.rootFrame);
      }

      /** @internal */
      public addFeature(view: any): void {
      ...
      /** @internal */
      public Button(featName: string): any {
        const layoutParams = LinearLayout$LayoutParams.$new(
          ViewGroup$LayoutParams.MATCH_PARENT.value,
          ViewGroup$LayoutParams.MATCH_PARENT.value,
        );
      ...
      public View$OnClickListener(fn: (view: any) => void): any {
      ...
      public SeekBar$OnSeekBarChangeListener({
        ...
        onProgressChanged?: (seekBar: any, progress: number, fromUser: boolean) => void;
        onStartTrackingTouch?: (seekBar: any) => void;
        onStopTrackingTouch?: (seekBar: any) => void;
      }): any {
        return Java.registerClass({
      ...
      /** @internal */
      public CompoundButton$OnCheckedChangeListener(
        fn: (buttonView: any, isChecked: boolean) => void,
      ): any {
        return Java.registerClass({
      ...
      /** @internal */
      public DialogInterface$OnClickListener(fn: (dialog: any, which: number) => void): any {
        return Java.registerClass({
          name: `${className}_OnClickListener$${lambdaCounter()}`,
      ...
      /** @internal */
      public View$OnTouchListener(): any {
        const menu = this;
        ...
        return Java.registerClass({
          ...
          methods: {
            onTouch(view: any, motionEvent: any): boolean {
      ...
      /** @internal */
      public convertDipToPixels(i: number): number {
        const displayMetrics = this.context.getResources().getDisplayMetrics();
    ...
    console.log('Getting main activity')
    Java.choose(activityName, {
      onMatch: function (instance: any) {
        console.log('Found main activity')
        mainActivity = instance;
      },
      onComplete: function () {
        console.log('Creating menu object')
        const __menu = new Menu(mainActivity, config_);
